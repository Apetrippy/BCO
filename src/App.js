    ...
    <s.Screen>
      ...
      >
        <ResponsiveWrapperHeader>
          <LogoDiv>
            <a href="https://Bohemian Club Owls.tk/" target={"home"}>
        ...
        <s.SecContainer id="story">
          ...
          Satirical Collections History
            ...
            subversive internet nazi troll culture. You can read the findings 
            at <a href="https://GordonGoner.com">GordonGoner.com</a> made by Ryder Ripps, warning this website
            ...
            <br></br>
            <br></br>
            On June 2022, <a href="https://twitter.com/DonnGregoor">DonnGregoor</a> began Minting Bohemian Club Owls for Otherside NFTS as Contemporary Conceptual Narrative Artwork. Bohemian Club Owls
            just like RR/BAYC uses satire and appropriation to protest and
            educate people regarding Bohemian Club Owls for Otherside and the framework
            ...
            <br></br>
            <br></br>
            Bohemian Club Owls uses the ERC721A standard, which saves significant gas
        ...
        <s.SecContainer id="faq">
          ...
          <PanelGroup
            ...
            bordered
          >
            <Panel header="What is a Bohemian Club Owls ?" defaultExpanded>
              <s.TextP style={{ textAlign: "left" }}>
                Satirical Conceptual Narrative Art Appropriation by @DonnGregoor69
            ...
            <Panel header="Are the original devs involved?">
              <s.TextP style={{ textAlign: "left" }}>
                No, @DonnGregoor69 is the only Artist/Dev behind the Conceptual Art.
              </s.TextP>
            </Panel>
            ...
            <Panel header="What the future of this project?">
              <s.TextP style={{ textAlign: "left" }}>
                ...
                DonnGregoor planned to release a Metaverse for the Bohemian Club Owls 26 Plots.
              </s.TextP>
            </Panel>
            <Panel header="Who runs the Bohemian Club Owls ?">
              <s.TextP style={{ textAlign: "left" }}>
                Bohemian Club Owls is a fully decentralized community with no leader.
